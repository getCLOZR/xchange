...
Requester-side demo: delegates **search** and **summarization** to specialized workers through Gleam — no hardcoded worker URLs.

## Prerequisites

1. Gleam API running (`http://localhost:8000`)

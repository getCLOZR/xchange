...
3. **Frontend** — `cd frontend`, `npm install`, `npm run dev` → [App Home](http://localhost:3000/app) · [Developer Console](http://localhost:3000) · [Agent Onboarding](http://localhost:3000/onboarding)
...
- Docs: [docs/features/ecommerce-launch-workflow-demo-v0.1.md](docs/features/ecommerce-launch-workflow-demo-v0.1.md)

Register the four ecommerce workers (ports 9201–9204), health-check, then run the demo.
